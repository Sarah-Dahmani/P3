//initialisation de la variable loggedIn qui vérifie si l'utilisateur est connecté 
const loggedIn = isLoggedIn();

//on selectionne le formulaire de connexion et on écoute event click sur le bouton se connecter//
